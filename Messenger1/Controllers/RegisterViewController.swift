...
class RegisterViewController: UIViewController {
    ...
    private let imageView: UIImageView = {
        ...
        imageView.image = UIImage(systemName: "person.crop.rectangle.stack.fill")
    ...
    @objc private func registerButtonTapped(){
        ...
        DatabaseManger.shared.userExists(with: email, completion:  {[weak self ] exists in
            guard let strongSelf = self else {
                return}
            guard !exists else {
                strongSelf.alertUserLoginError(message: "Loks liks a user account for that email address already exists. ")
                return
            }
    ...
    func alertUserLoginError(message: String = "Please enter all information to create a new account."){
        let alret = UIAlertController(title: "Woops", message: message , preferredStyle: .alert)
